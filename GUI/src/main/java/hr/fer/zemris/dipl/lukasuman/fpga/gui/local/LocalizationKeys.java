...
public class LocalizationKeys {
    ...
    public static final String THERE_IS_NO_SESSION_TO_SAVE_KEY = "there_is_no_selected_session_to_be_saved";
    public static final String SESSION_S_WAS_MODIFIED_KEY = "session_s_was_modified";
    public static final String SAVE_CHANGES_KEY = "save_changes";
