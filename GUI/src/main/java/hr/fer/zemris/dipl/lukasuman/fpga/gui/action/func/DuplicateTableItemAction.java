...
public class DuplicateTableItemAction<T extends Duplicateable & Nameable> extends AbstractAppAction {

    private GUIControllerProvider<T> controllerProvider;

    public DuplicateTableItemAction(JFPGA jfpga, GUIControllerProvider<T>  controllerProvider, String localizationKey) {
